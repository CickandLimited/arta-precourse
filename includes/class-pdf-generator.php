...
class Ayotte_PDF_Generator {
    ...
    public static function create_user_pdf($user_id) {
        ...
        $html .= '</table>';
        if ($id_file) {
            $html .= '<p>Photo ID:</p><img src="' . esc_url($id_file) . '" style="width:100%;max-width:400px;" />';
        }
                        ...
                        foreach ($data as $key => $val) {
                            ...
                            if ($type === 'file' && $val) {
                                ...
                                if ($ext === 'pdf' && method_exists($mpdf, 'SetSourceFile')) {
                                    ...
                                    $html .= '<tr><th>' . esc_html($label) . '</th><td><img src="' . esc_url($path) . '" style="width:100%;max-width:400px;" /></td></tr>';
                                }
                            } else {
